...
})({"lWV3f":[function(require,module,exports) {
...
class PostsService {
    ...
    getUserById(id) {
        return (0, _apiService.apiService).get(`${this._basePath}/${id}`);
    }
    getUsersByUserId(userId) {
        return (0, _apiService.apiService).get(`${this._basePath}?userId=${userId}`);
    }
    create(obj) {
        return (0, _apiService.apiService).post(this._basePath, obj);
    }
    updateById(id, obj) {
        return (0, _apiService.apiService).put(`${this._basePath}/${id}`, obj);
    }
    deleteById(id) {
...
},{"../data/elements":"cgY6J","@parcel/transformer-js/src/esmodule-helpers.js":"lkvqk"}]},["lWV3f","ebWYT"], "ebWYT", "parcelRequire4502")
